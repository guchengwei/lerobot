...
(see the comment in ``packages/lerobot-wandb/pyproject.toml``): it is a companion
...
# with the ``lerobot`` extra in ``packages/lerobot-wandb/pyproject.toml``.
SUPPORTED_LEROBOT_RANGE = ">=0.6.1,<0.7.0"
